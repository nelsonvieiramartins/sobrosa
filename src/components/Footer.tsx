      ...
      <div className="max-w-[1440px] mx-auto">
        ...
        {!hideNewsletter && <div className="grid grid-cols-12 gap-8 items-center pb-20 border-b border-white/10">
          <div className="col-span-12 lg:col-span-6">
            ...
            <p className="text-gray-400 max-w-md">
              Receba lançamentos exclusivos e promoções diretamente no seu
              e-mail.
            </p>
          </div>
          <div className="col-span-12 lg:col-span-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 py-20">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-8">
              Elevando o padrão do vestuário esportivo com inovação e
              autenticidade diretamente do centro-oeste para o mundo.
            </p>
          ...
          {/* Explorar */}
          <div>
            <h4 className="font-bold uppercase text-sm tracking-widest mb-8">
              Explorar
            </h4>
        ...
        <div className="pt-12 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-xs text-gray-500 uppercase tracking-widest">
            © 2024 SOBROSA. TODOS OS DIREITOS RESERVADOS.
          </p>
